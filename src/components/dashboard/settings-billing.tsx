    ...
    <div className="space-y-8">
      <Card>
        <CardContent className="space-y-6 pt-6">
          ...
          {bonusCredits > 0 && (
            <div className="flex justify-between text-sm">
              <span className="text-[#4A4A4A]">Bonus credits</span>
              <span className="font-medium text-[#7C3AED]">
                {bonusCredits} images available
              </span>
            </div>
          )}
          {currentPeriodEnd && (
      ...
      <Card>
        <CardContent className="space-y-4 pt-6">
          <CardTitle>Need More Images?</CardTitle>
          <p className="text-sm text-[#4A4A4A]">
            Buy token packs for extra images that never expire. Use them after
            your monthly quota runs out.
          </p>
          <TokenPackGrid
